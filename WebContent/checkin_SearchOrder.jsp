                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${order.processed eq 0}">
                                    <button class="layui-btn layui-btn-xs" type="submit" name="order_id" value="${order.order_id}">排房</button>
                                    <button class="layui-btn layui-btn-xs layui-btn-danger layui-btn-disabled" type="submit" name="xuzhu" value="${order.order_id}">续住</button>
                                </c:if>
                                <c:if test="${order.processed eq 1}">
                                    <button class="layui-btn layui-btn-xs layui-btn-disabled"   disabled="disabled">排房</button>
                                    <button class="layui-btn layui-btn-xs layui-btn-danger " type="submit" name="xuzhu" value="${order.order_id}">续住</button>
                                </c:if>
                                <c:if test="${order.processed eq 2}">
                                    <button class="layui-btn layui-btn-xs layui-btn-disabled"   disabled="disabled">排房</button>
                                    <button class="layui-btn layui-btn-xs layui-btn-danger layui-btn-disabled" type="submit" name="xuzhu" value="${order.order_id}">续住</button>
